...
俺のゼニはどこ行ったの多摩市バージョンです。
八王子市をベースにしています。


##以下、fork元の八王子バージョンに関する記載になります。

# 俺のゼニはどこ行った for 八王子

俺のゼニはどこ行ったの八王子バージョンです。
多年度対応していますが、汎用性はありません・・・
多年度対応のポイントとしては
openspending.orgに登録する際にキーとしてtime(年)を含むこと。
index.html, bubbletree.htmlに再ロードするよう修正したこと。
です。
